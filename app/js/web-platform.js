...
// This also creates the plugin's private namespace com_amd_mxgpui
//
...
if (!com_amd_mxgpui) {
   ...
   com_amd_mxgpui.webContextPath = WEB_PLATFORM.getRootPath() + "/mxgpui";
   ...
   (function () {
      ...
      function getString(key, params) {
         return WEB_PLATFORM.getString("com_amd_mxgpui", key, params);
      }
      ...
      // Functions exported to the com_amd_mxgpui namespace
